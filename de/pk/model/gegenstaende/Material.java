...
/**
 * Materialien bilden die Grundlage fuer das Craften von neuen Gegenstaenden.
 * Materialien sind Stapelbar, koennen jedoch weder ausgeruestet noch konsumiert
 * werden.
 *
 * @author Dylan
 */
public enum Material implements Stapelbar
{
	 ...
	 */
	LEER, HOLZ, SEHNE, STOFF, EISEN, STEIN;
	...
	{
		return Material.MATERIALIEN_SIND_AUSRUESTBAR;
	}
	...
	{
		return Material.MATERIALIEN_SIND_KONSUMIERBAR;
	}
