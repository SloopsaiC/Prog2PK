...
public class KartenGenerator
{
	...
	{
		Kachel generiert = new Kachel(new StartUntergrund());
		return generiert;
	}
	 ...
	 */
	public void registriereUntergrundKachel(KartenGeneratorUntergrund insRegister)
	{
	...
	private boolean ueberpruefeFreiesRandFeldUntergrund(KartenGeneratorUntergrund zuUeberpruefen)
	{
