...
public class KartenRandKachel extends KartenGeneratorKachel
{
	...
	{
			{ KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE },
			{ KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE },
			{ KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE },
			{ KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE, KachelWertigkeit.ENDE },
			{ KachelWertigkeit.ENDE, KachelWertigkeit.FREI, KachelWertigkeit.FREI, KachelWertigkeit.FREI, KachelWertigkeit.ENDE } };
	...
	{
		if (pruefeObAmRand(maximalGroesseX, maximalGroesseY, aktuellePositionX, aktuellePositionY))
		{
			return STANDART_WAHRSCHEINLICHKEIT_WENN_AM_RAND;
		}
