...
public class DE_de extends Lokalisierung
{
     ...
     */
    public static final String BEGRUESSUNG_BEI_PROGRAMMSTART
            = "Herzlich willkommen im Spiel \"KI - Katastrophe auf Iava\".";


    /**
     * Fragt, was als naechstes getan werden soll. Meistens vor der Auflistung von moeglichen Optionen zur Eingabe.
     */
    public static final String MENUE_WAS_TUN = "Was wollen Sie tun?";

    /**
     * Informiert darueber, dass die getaetigte Eingabe nicht mit den Erwartungen und den aufgelisteten Moeglichkeiten
     * uebereinstimmt.
     */
    ...
    /**
     * Listet die unterschiedlichen Optionen bzw. Aktionsmoeglichkeiten mit zugehoerigem Eingabesymbol fuer das
     * Hauptmenue auf.
     */
    public static final String HAUPTMENUE_AKTIONSAUSWAHL
            = "\tn = neues Spiel starten " + "\n\ts = gespeichertes Spiel laden "
            + "\n\tc = Crafting" + "\n\to = Optionen und Einstellungen \n\tx = beenden";


    /**
     * Informiert den Anwender darueber, dass er sich im Menue der Einstellungen / Optionen befindet.
     */
     ...
     * Optionsmenue auf.
     */
    public static final String OPTIONSMENUE_AKTIONSAUSWAHL
     ...
     * Crafting-Menue auf.
     */
    public static final String CRAFTINGMENUE_AKTIONSAUSWAHL
            = "\tn = versuchen neuen Gegenstand zu craften" + "\n\tx = abbrechen";

    /**
     * Zeigt das vorgehen und die Eingabesyntax mit zugehoerigem Eingabesymbol fuer das Craften auf.
     */
    public static final String CRAFTEN_INFO
            = "Gib deine Materialien in 3x3 Form ein (3 Zeilen mit je 3 Materialien durch \", \" getrennt), x = abbrechen";
    ...
    /**
     * Fuer die erneute Ausgabe der Materialieneingabe beim Craften zur Ueberprufeung.
     */
    ...
    /**
     * sinnfreie Testausgabe anstelle der eigentlichen Implementierung der Heldenphase.
     */
    public static final String TESTAUSGABE_PHASEN_HELDENPHASE = "^^Heldenphase^^";

    /**
     * sinnfreie Testausgabe anstelle der eigentlichen Implementierung der Explorationsphase.
     */
    public static final String TESTAUSGABE_PHASEN_EXPLORATIONSPHASE = "^^Explorationsphase^^";


    /**
     * Splitter von Eingabe, die im Code getrennt werden sollen, wie die Materialieneingabe in einer Zeile beim Craften.
     */
    ...
    /**
     * Eingabsymbol zum Beenden oder Zurueckkehren in das vorherige / uebergeordnete Menue.
     */
