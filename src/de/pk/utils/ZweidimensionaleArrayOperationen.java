...
/**
 * Hilfsklasse, um zweidimensionale Arrays beliebigen Typs zu drehen, spiegeln und Enum-Arrays zu vergleichen.
 *
 * @author Dylan
 */
public abstract class ZweidimensionaleArrayOperationen
{
    ...
    /**
     * Vergleicht zwei 2D-Arrays eines Enum-Typen miteinander und liefert wahr, wenn beide Arrays den gleichen Inhalt
     * auf genau den gleichen Indizes haben.
     *
     * @param <E>        Ein Enum-Typ, von dem beide zu vergleichende Arrays sind.
     * @param enumArray1 zweidimensionales Array vom Typ E.
     * @param enumArray2 zweidimensionales Array vom Typ E zum Vergleich mit enumArray1.
     *
     * @return wahr, wenn enumArray1 und enumArray2 identische Werte auf den gleichen Indizes beinhalten.
     */
    ...
    /**
     * Dreht ein quadratisches, zweidimensionales Array vom Typ T anzahlDrehungen oft um 90 Grad im Uhrzeigersinn
     * ("rechts herum"). Ist anzahlDrehungen < 1, so wird array unveraendert zureckgegeben.
     *
     * @param <T>             Der Typ, von dem sowohl array als auch das zurueckgegebene Array sind.
     * @param array           Zu drehendes Array vom Typ T.
     * @param anzahlDrehungen Die Anzahl, um die array im Uhrzeigersinn gedreht werden soll.
     *
     * @return Eine Kopie von array um anzahlDrehungen oft um 90 Grad im Uhrzeigersinn gedreht oder array selbst, falls
     *         anzahlDerhungen < 1.
     */
    ...
    /**
     * Spiegelt ein quadratisches, zweidimensionales Array vom Typ T vertikal (senkrecht).
     *
