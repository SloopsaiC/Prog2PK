...
/**
 * Hilfklasse stellt Methoden zur Konsolenausgabe bereit (z.B. zu Debug- oder Testzwecken).
 *
 * @author Dylan
 */
public abstract class DebugAusgabeKlasse
{
    ...
    /**
     * Gibt den String info in der Konsole aus. Verhaelt sich exakt wie ein Aufruf von System.out.println(info).
     *
    ...
    /**
     * Gibt ein zweidimensionales Array aus, indem von jedem Objekt von array die toString()-Methode aufgerufen wird.
     * Spalten von array werden mit " | " getrennt. Eine Beschriftung, Ueberschrift oder sonstige Info kann mit info
     * eine Zeile ueber array ausgegeben werden.
     *
     * @param info  Beschriftung o.ae., wird in der Zeile vor array ausgegeben.
     * @param array Ein zweidimensionales Array, welches in "Tabellenform" ausgegeben wird. Spalten werden mit " | "
     *              getrennt.
     */
