...
import static de.pk.model.gegenstaende.Material.SEHNE;
import static de.pk.model.gegenstaende.Material.STOFF;
...
/**
 * Enum mit "Rezepten" fuer das Crafting, sie bilden die Grundlage des
 * Crafting-Systems. Jedes Rezept beinhaltet einen craftGegenstand sowie ein
 * Muster aus Materialien, welche beim Craften in der Form des Musters erraten
 * werden muessen, um den jeweiligen Gegenstand herzustellen.
 *
 * @author Dylan
 */
public enum CraftingRezept
{
	...
	BRUSTPANZER_REZEPT(new Material[][]
	{
			{ EISEN, EISEN, EISEN },
			{ LEER, EISEN, LEER },
			{ LEER, EISEN, LEER } }, Ruestung.BRUSTPANZER),
	/**
	...
	SCHILD_REZEPT(new Material[][]
	{
			{ HOLZ, HOLZ, HOLZ },
			{ HOLZ, EISEN, HOLZ },
			{ HOLZ, HOLZ, HOLZ } }, Ruestung.SCHILD),
	/**
	...
	RING_REZEPT(new Material[][]
	{
			{ LEER, EISEN, LEER },
			{ EISEN, LEER, EISEN },
			{ LEER, EISEN, LEER } }, Accessoire.RING),
	/**
	...
	AMULETT_REZEPT(new Material[][]
	{
			{ LEER, STOFF, LEER },
			{ LEER, EISEN, LEER },
			{ LEER, LEER, LEER } }, Accessoire.AMULETT);
	...
	/**
	 * Der Gegenstand, welcher bei der korrekten Kombination des entsprechenden
	 * Musters gecraftet wird.
	 */
	 ...
	 *
	 * @param craftingMaterialMuster 2D-Material-Array, das als Vorlage zum Craften
	 *                               dient.
	 * @param craftGegenstand        Bei korrekter Kombination, die dem Muster
	 *                               entspricht, soll dieser Gegenstand gecraftet
	 *                               werden.
	 */
	...
	/**
	 * Gibt den Gegenstand zurueck, welcher durch das Erraten des zugehoerigen
	 * Musters gecraftet werden kann.
	 *
