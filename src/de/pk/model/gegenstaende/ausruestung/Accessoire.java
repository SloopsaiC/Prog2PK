...
/**
 * Accessoires sind Gegenstaende und koennen ausgeruestet werden. Sie werden eingesetzt, um bestimmte, dauerhafte
 * Effekte zu bewirken.
 *
 * @author Dylan
 */
public enum Accessoire implements Ausruestbar
{
    ...
    RING(new StatusEffekt(1, 1, 0, 1), Faehigkeit.STIL),
    AMULETT(new StatusEffekt(0, 2, 2, 2), Faehigkeit.KEINE);
     ...
     * @param vorraussetzungen    Array mit Faehigkeiten, die Voraussetzung sind, das Accessoire zu tragen.
     */
     ...
     *
     * @return Array mit Faehigkeiten, die als Voraussetzung notwenig sind, um das Accessoire auszuruesten.
     */
    @Override
