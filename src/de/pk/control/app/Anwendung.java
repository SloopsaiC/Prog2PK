...
/**
 * Die Anwendung verwaltet die Auswahl eines Spielstandes, die Bearbeitung von Optionen und das Starten eines Spiels.
 *
 * @author Dylan
 */
public class Anwendung
{
    ...
    /**
     * Die Anwendung (Dieses aktuelle Objekt) wird initialisiert, Einstellungen werden uebernommen.
     */
    ...
    /**
     * Wird im Hauptmenue der Punkt "Neues Spiel" gewaehlt, wird hier ein neues Spiel initialisiert.
     */
    private void neuesSpiel ()
    {
        WeltkarteController weltkarte
                = new WeltkarteController(new DungeonController(DE_de.TESTAUSGABE_DUNGEON_NAME[0]),
                        new DungeonController(DE_de.TESTAUSGABE_DUNGEON_NAME[1]));
    ...
    /**
     * Wird im Hauptmenue die Option "Spiel Laden" gewaehlt, wird dies hier behandelt.
     */
    ...
    /**
     * Initialisiert zunaechst die Anwendung und startet dann die Anwendungsschleife.
     */
